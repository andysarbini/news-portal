        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="position-relative mb-3">
                    <img class="img-fluid w-100" src="{{ Storage::disk('public')->url($article->image) }}" style="object-fit: cover;">
                    <div class="overlay position-relative bg-light">
                        <div class="mb-3">
                            <a href="">{{ $article->kategori->name }}</a>
                            <span class="px-1">/</span>
                            {{-- <span>January 01, 2045</span> --}}

                            <span>{{ $article->created_at->isoFormat('dddd, D MMMM Y')}}</span>
                            {{-- <span>{{ Carbon::($item->created_at)->isoFormat('dddd, D MMMM Y'); }}</span> --}}
                        </div>
                        <div>
